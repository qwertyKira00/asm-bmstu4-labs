...
lp2:
        ...
        MOV AL, matrix[BX]
        ADD BX, 1
        MOV matrix[BX], AL           ;Затираем 0 значением из предыдущего столбца
...
main:
	     MOV    AX, DataS1
	     MOV    DS, AX
	     CALL   PRINT_MESSAGE           ;Вывод приглашения
       CALL   INPUT_DIMENSION         ;Ввод размерности
       CALL   INPUT_MATRIX            ;Ввод матрицы
       CALL   COLUMN_EXCHANGE         ;Замена столбца
